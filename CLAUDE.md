...
- `club-dashboard.html` → no club shown, just "Add a New Club". `?club=PACMS` → one club button (`club-dashboard.js`; one club at a time). Click → `club-manage.html?club=PACMS`.
