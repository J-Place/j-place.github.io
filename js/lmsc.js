...
var options = {
    ...
    valueNames: [ 'firstName', 'lastName', 'miles', 'age', 'clubs', 'lmscs', 'name' ],
  };
...
// function formatData(first, last, age, miles, club, lmsc, zone) {  
//     // miles = miles.toFixed(2);
//     // return miles;
//     first = lmscs.clubs.members.firstName;
//     last = lmscs.clubs.members.lastName;
//     age = lmscs.clubs.members.age;
//     miles = lmscs.clubs.members.miles;
//     club = mscs.clubs.abbreviation;
//     lmsc = lmscs.name;
//     zone = name;
//     return first, last, age, miles, club, lmsc, zone;
// }

function convertMemberData(dataLmscLocal) {

    lmscs = dataLmscLocal[0].lmscs;
    clubs = dataLmscLocal[3].lmscs[0].clubs;
    members = dataLmscLocal[1].lmscs[0].clubs[0].members;

    // if (lmscs.length > 0) {
    //     console.log("We have LMSCs");
    // }
    // for (let i = 0; i < lmscs.length; i++) {
    //     var lmscName = lmscs[i].name
    //     // console.log(lmscName);
    //     // let name = lmscName;
    //     // return name;
    // }
    // for (let i = 0; i < clubs.length; i++) {
    //     var clubName = clubs[i].abbreviation;
    //     console.log(clubName);
    //     // let abbreviation = clubName;
    //     // return abbreviation;
    // }
    for (let i = 0; i < members.length; i++) {
        var lastName = members[i].lastName;
        // console.log(lastName);
        console.log(members[i].firstName + " " + lastName);
        console.log(members[i].parent);
        // return lastName;
    }
    // console.log(lastName);
    // return lmscName && clubName && lastName;
}



let newData = dataLmscLocal; // Use local data object until api access is fixed
convertMemberData(dataLmscLocal);

// let xxx = {
//     zone: dataLmscLocal,
//     lmscs: dataLmscLocal.lmscs,
// }


// Initialize List.js
var listLmsc = new List('listLmsc', options, newData );
...
// var listLastName = dataLmscLocal[0].lmscs[0].clubs[1].members[0].lastName;
// var listFirstName = dataLmscLocal[0].lmscs[0].clubs[1].members[0].firstName;
// console.log(listFirstName + " " + listLastName);


// const { lmscs: { name, id } } = dataLmscLocal;
