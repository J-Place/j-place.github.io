  ...
  function openModal(data) {
    ...
    if (courses.length) {
      var items = courses.map(function (c) {
        ...
        return '<div class="pool-course-item">'
          + '<span class="pool-course-item__name">'         + escapeHtml(poolName)     + '</span>'
          + '<ul>'
          + '<li class="pool-course-item__length">'         + escapeHtml(c.length||'') + '</li>'
          + '<li class="pool-course-item__lanes">'          + escapeHtml(lanesTxt)     + '</li>'
          + '<li class="pool-course-item__bulkhead">'       + escapeHtml(bulkheadTxt)  + '</li>'
          + '<li class="pool-course-item__certified-date">' + escapeHtml(certifiedTxt) + '</li>'
          + '<li class="pool-course-item__touchpads">'      + escapeHtml(touchpadTxt)  + '</li>'
          + '</ul>'
          + '</div>';
      }).join('');
      coursesEl.innerHTML = '<div class="pool-course-list">' + items + '</div>';
    } else {
      coursesEl.innerHTML = '';
    }
